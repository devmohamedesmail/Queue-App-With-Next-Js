  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-main/5 to-white">
      ...
      <div className='container m-auto px-5 flex-1 flex flex-col justify-center'>
        <div className='w-full md:w-2/3 lg:w-1/3 m-auto mt-10 p-8 shadow-sm rounded-2xl my-10 bg-white/95 border border-gray-100'>
          <div className='flex justify-center gap-5 my-10  py-2 px-2 rounded-xl'>
            <button className={`px-5 py-2 flex-1 transition-colors ease-in-out duration-500 rounded-lg text-sm font-semibold shadow-sm ${activeTab === 'login' ? 'bg-main text-white' : 'bg-white text-main border border-main'}`} onClick={() => setActiveTab('login')}>{t('common.login')}</button>
            <button className={`px-5 py-2 flex-1 transition-colors ease-in-out duration-500 rounded-lg text-sm font-semibold shadow-sm ${activeTab === 'register' ? 'bg-main text-white' : 'bg-white text-main border border-main'}`} onClick={() => setActiveTab('register')}>{t('common.register')}</button>
          </div>
