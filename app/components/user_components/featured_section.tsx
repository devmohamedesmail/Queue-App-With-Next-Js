...
export default function Featured_Section() {
  ...
  const features = [
    {
      title: t('user.home-page.real-time-title'),
      description: t('user.home-page.real-time-desc'),
      icon: <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6l4 2" />
      </svg>,
    },
    {
      title: t('user.home-page.multi-role-title'),
      description: t('user.home-page.multi-role-desc'),
      icon: <svg className="w-8 h-8 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
      </svg>,
    },
    {
      title: t('user.home-page.analytics-title'),
      description: t('user.home-page.analytics-desc'),
    ...
    {
      title: t('user.home-page.smart-notifications-title'),
      description: t('user.home-page.smart-notifications-desc'),
      icon: <svg className="w-8 h-8 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: t('user.home-page.mobile-first-title'),
      description: t('user.home-page.mobile-first-desc'),
      icon: <svg className="w-8 h-8 text-secondary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
      </svg>,
    },
    {
      title: t('user.home-page.secure-title'),
      description: t('user.home-page.secure-desc'),
      icon: <svg className="w-8 h-8 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section id="features" className="py-20 bg-gradient-to-br from-base-100 to-base-200">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 */}
          {/* <div className="group bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-sm hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
